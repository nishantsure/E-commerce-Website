...
SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
    http
          .sessionManagement(smc -> smc.invalidSessionUrl("/invalidSession").maximumSessions(3).maxSessionsPreventsLogin(true))    //.expiredUrl("/expiredSession") for expired url page
            // .redirectToHttps((https) -> https.requestMatchers(AnyRequestMatcher.INSTANCE))  //for https protocol
