...
import com.example.AmazonClone.filter.*;
...
public class TestEnvSecurityConfig {
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
        ...
        TestEnvUsernamePwdAuthenticationProvider authenticationProvider =
                new TestEnvUsernamePwdAuthenticationProvider(userDetailsService, passwordEncoder);
