...
import com.example.AmazonClone.dto.LoginRequestDTO;
import com.example.AmazonClone.dto.LoginResponseDTO;
...
public class UserController {
    ...
    public Users getUserDetailsAfterLogin(Authentication authentication) {
        Users optionalUser = userRepo.findByEmail(authentication.getName());
        return optionalUser;
    }
    ...
    public ResponseEntity<LoginResponseDTO> apiLogin (@RequestBody LoginRequestDTO loginRequest) {
        ...
        if(null != authenticationResponse && authenticationResponse.isAuthenticated()) {
            if (null != env) {
                ...
                jwt = Jwts.builder().issuer("Amazon Clone").subject("JWT Token")
